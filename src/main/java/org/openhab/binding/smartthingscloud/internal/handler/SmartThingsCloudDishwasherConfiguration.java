...
/**
 * Configuration for a SmartThings Cloud dishwasher thing.
 *
 * @author openHAB Samsung Cloud Binding - Initial contribution
 */
@NonNullByDefault
public class SmartThingsCloudDishwasherConfiguration {
    ...
    /**
     * Polling interval in seconds for fetching dishwasher status from SmartThings API.
     */
