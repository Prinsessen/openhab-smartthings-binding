...
/**
 * Configuration for a SmartThings Cloud dryer thing.
 *
 * @author openHAB Samsung Cloud Binding - Initial contribution
 */
@NonNullByDefault
public class SmartThingsCloudDryerConfiguration {
    ...
    /**
     * Polling interval in seconds for fetching dryer status from SmartThings API.
     */
