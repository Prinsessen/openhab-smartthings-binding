...
import org.openhab.binding.smartthingscloud.internal.handler.SmartThingsCloudDishwasherHandler;
...
public class SmartThingsCloudHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_DISHWASHER.equals(uid)) {
            return new SmartThingsCloudDishwasherHandler(thing);
        }
